...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7ba8458, const void *arg_0xb7ba85f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b598c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a03840), 
int (*key_eq_fn)(void *arg_0xb7a03c88, void *arg_0xb7a03e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78d29b8, int arg_0xb78d2b10);
static double RandomUniform(void );
...
typedef nx_struct radio_route_msg {
  ...
  nx_uint16_t value;
} __attribute__((packed)) radio_route_msg_t;
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer1$startOneShot(uint32_t dt);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
static void RadioRouteC$Leds$led0Toggle(void );
#line 83
static void RadioRouteC$Leds$led1Toggle(void );
#line 100
static void RadioRouteC$Leds$led2Toggle(void );
#line 117
static uint8_t RadioRouteC$Leds$get(void );
# 43 "RadioRouteC.nc"
#line 39
typedef struct RadioRouteC$__nesc_unnamed4334 {
  uint16_t destination;
  uint16_t next_hop;
  uint16_t cost;
} RadioRouteC$RoutingEntry;

RadioRouteC$RoutingEntry RadioRouteC$routing_table[1000][7];

message_t RadioRouteC$packet[1000];
message_t RadioRouteC$dataP[1000];


message_t RadioRouteC$queued_packet[1000];
uint16_t RadioRouteC$queue_addr[1000];
uint16_t RadioRouteC$time_delays[1000][7];
int RadioRouteC$person_code[1000][8];
int RadioRouteC$num_received[1000];



bool RadioRouteC$route_req_sent[1000];
bool RadioRouteC$route_rep_sent[1000];

bool RadioRouteC$sentData[1000];


bool RadioRouteC$locked[1000];

static inline bool RadioRouteC$actual_send(uint16_t address, message_t *packet);
static bool RadioRouteC$generate_send(uint16_t address, message_t *packet, uint8_t type);
...
#line 186
static inline void RadioRouteC$handleLeds(void );
#line 204
static inline message_t *RadioRouteC$Receive$receive(message_t *bufPtr, 
...
#line 126
# 117 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static uint8_t RadioRouteC$Leds$get(void ){
#line 117
...
{
  LedsP$Led2$toggle();
  sim_log_debug(213U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}

# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioRouteC$Leds$led2Toggle(void ){
#line 100
...
{
  LedsP$Led1$toggle();
  sim_log_debug(210U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 101
  ;
}

# 83 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioRouteC$Leds$led1Toggle(void ){
#line 83
...
{
  LedsP$Led0$toggle();
  sim_log_debug(207U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 86
  ;
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioRouteC$Leds$led0Toggle(void ){
#line 67
...
#line 186
{
  int person_digit = RadioRouteC$person_code[sim_node()][RadioRouteC$num_received[sim_node()] % 8];
  int led_index = person_digit % 3;

#line 189
  RadioRouteC$num_received[sim_node()]++;
  if (led_index == 0) {
    RadioRouteC$Leds$led0Toggle();
    }
  else {
#line 192
    if (led_index == 1) {
      RadioRouteC$Leds$led1Toggle();
      }
    else {
#line 195
      RadioRouteC$Leds$led2Toggle();
      }
    }
#line 196
  sim_log_debug(158U, "radio", "Node %d received %d messages, current code digit: %d , updated led %d \n", TOS_NODE_ID, RadioRouteC$num_received[sim_node()], person_digit, led_index);

  sim_log_debug(159U, "led_0", "Led 0 status %u\n", RadioRouteC$Leds$get() & LEDS_LED0);
  sim_log_debug(160U, "led_1", "Led 1 status %u\n", RadioRouteC$Leds$get() & LEDS_LED1);
  sim_log_debug(161U, "led_2", "Led 2 status %u\n", RadioRouteC$Leds$get() & LEDS_LED2);
}
...
#line 215
      RadioRouteC$handleLeds();
      if (__nesc_ntoh_uint16(rcm->type.nxdata) == 0) {
          int node_requested = __nesc_ntoh_uint16(rcm->node_requested.nxdata);

#line 218
          sim_log_debug(162U, "radio", "Node %d received a data message\n", TOS_NODE_ID);
          if (node_requested == TOS_NODE_ID) {

              sim_log_debug(163U, "radio", "Node %d was the destination of data %d from node %d \n", TOS_NODE_ID, __nesc_ntoh_uint16(rcm->value.nxdata), __nesc_ntoh_uint16(rcm->sender.nxdata));
            }
          else {



              int next_hop = RadioRouteC$routing_table[sim_node()][node_requested - 1].next_hop;
              radio_route_msg_t *contentToSend = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

#line 229
              __nesc_hton_uint16(contentToSend->type.nxdata, 0);
              __nesc_hton_uint16(contentToSend->sender.nxdata, __nesc_ntoh_uint16(rcm->sender.nxdata));
              __nesc_hton_uint16(contentToSend->node_requested.nxdata, __nesc_ntoh_uint16(rcm->node_requested.nxdata));
              __nesc_hton_uint16(contentToSend->value.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata));
              RadioRouteC$generate_send(next_hop, &RadioRouteC$packet[sim_node()], 0);
            }
        }
      else {
#line 236
...
#line 238
            sim_log_debug(164U, "radio", "Node %d received a route request message for %d \n", TOS_NODE_ID, node_requested);
            if (node_requested == TOS_NODE_ID) {

                radio_route_msg_t *contentToSend = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

#line 242
                __nesc_hton_uint16(contentToSend->type.nxdata, 2);
                __nesc_hton_uint16(contentToSend->sender.nxdata, TOS_NODE_ID);
                __nesc_hton_uint16(contentToSend->node_requested.nxdata, TOS_NODE_ID);
                __nesc_hton_uint16(contentToSend->value.nxdata, 1);
                RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 2);
              }
            else {
                if (RadioRouteC$routing_table[sim_node()][node_requested - 1].destination == (void *)0) {

                    radio_route_msg_t *contentToSend = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

#line 252
                    __nesc_hton_uint16(contentToSend->type.nxdata, 1);
                    __nesc_hton_uint16(contentToSend->node_requested.nxdata, node_requested);
                    RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 1);
                  }
                else {
...
#line 259
                    ...
                    __nesc_hton_uint16(contentToSend->sender.nxdata, TOS_NODE_ID);
                    __nesc_hton_uint16(contentToSend->node_requested.nxdata, node_requested);
                    __nesc_hton_uint16(contentToSend->value.nxdata, RadioRouteC$routing_table[sim_node()][node_requested - 1].cost + 1);
                    RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 2);
                  }
              }
          }
...
#line 269
            sim_log_debug(165U, "radio", "Node %d received a route reply message\n", TOS_NODE_ID);
            if (node_requested == TOS_NODE_ID) {

                sim_log_debug(166U, "radio", "I am the request of the reply, do nothing \n");
              }
            else {
                if (RadioRouteC$routing_table[sim_node()][node_requested - 1].destination == (void *)0 || RadioRouteC$routing_table[sim_node()][node_requested - 1].cost > __nesc_ntoh_uint16(rcm->value.nxdata)) {

                    radio_route_msg_t *contentToSend = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

#line 278
                    RadioRouteC$routing_table[sim_node()][node_requested - 1].destination = node_requested;
                    RadioRouteC$routing_table[sim_node()][node_requested - 1].cost = __nesc_ntoh_uint16(rcm->value.nxdata);
                    RadioRouteC$routing_table[sim_node()][node_requested - 1].next_hop = __nesc_ntoh_uint16(rcm->sender.nxdata);
                    __nesc_hton_uint16(contentToSend->type.nxdata, 2);
                    __nesc_hton_uint16(contentToSend->sender.nxdata, TOS_NODE_ID);
                    __nesc_hton_uint16(contentToSend->node_requested.nxdata, node_requested);
                    __nesc_hton_uint16(contentToSend->value.nxdata, RadioRouteC$routing_table[sim_node()][node_requested - 1].cost + 1);
                    sim_log_debug(167U, "radio", "Updating routing and sending cost for node %d \n", node_requested);
                    if (TOS_NODE_ID == 1 && node_requested == 7 && RadioRouteC$sentData[sim_node()] == FALSE) {

                        RadioRouteC$sentData[sim_node()] = TRUE;
                        RadioRouteC$Timer1$startOneShot(1000);
                      }
                    RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 2);
                  }
                else {

                    sim_log_debug(168U, "radio", "Node already present or cost higher than previous, do nothing \n");
                  }
              }
          }
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7673298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7673298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7673298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7673930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7673930, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(153U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);
      if (TOS_NODE_ID == 1) {
        RadioRouteC$Timer1$startOneShot(5000);
        }
    }
  else 
#line 148
    {
      sim_log_error(154U, "radio", "Radio failed to start for node %d, retrying...\n", TOS_NODE_ID);
...
#line 155
{
  sim_log_debug(155U, "boot", "Application stopped for node: %d \n", TOS_NODE_ID);
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76828b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76828b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb736f258, message_t * msg, error_t error){
#line 100
  switch (arg_0xb736f258) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb736f258, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb782e650){
#line 75
  switch (arg_0xb782e650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb782e650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb736fc40, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb736fc40, addr, msg, len);
#line 80
...
#line 117
{
  ...
  if (RadioRouteC$locked[sim_node()]) {
      sim_log_debug(149U, "radio", "Locked \n");
      return;
    }
  if (RadioRouteC$AMSend$send(address, packet, sizeof(radio_route_msg_t )) == SUCCESS) {
      sim_log_debug(150U, "radio_send", "Sending packet");
      RadioRouteC$locked[sim_node()] = TRUE;
      sim_log_debug_clear(151U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 108
{
  ...
  sim_log_debug(148U, "radio", "Timer 0 fired \n");
...
#line 159
{
  ...
  int destAddress = 7;
  radio_route_msg_t *contentToSend = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$dataP[sim_node()], sizeof(radio_route_msg_t ));
  radio_route_msg_t *broadReq = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

#line 166
  sim_log_debug(156U, "radio", "Timer 1 fired \n");
  if (RadioRouteC$routing_table[sim_node()][destAddress - 1].destination == (void *)0) {

      __nesc_hton_uint16(broadReq->type.nxdata, 1);
      __nesc_hton_uint16(broadReq->node_requested.nxdata, 7);
      RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 1);
    }
  else {

      __nesc_hton_uint16(contentToSend->type.nxdata, 0);
      __nesc_hton_uint16(contentToSend->sender.nxdata, 1);
      __nesc_hton_uint16(contentToSend->node_requested.nxdata, 7);
      __nesc_hton_uint16(contentToSend->value.nxdata, 5);
      sim_log_debug(157U, "radio", "Can send the data, next hop: %d \n", RadioRouteC$routing_table[sim_node()][destAddress - 1].next_hop);
      RadioRouteC$generate_send(RadioRouteC$routing_table[sim_node()][destAddress - 1].next_hop, &RadioRouteC$dataP[sim_node()], 0);
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73c93a8){
#line 83
  switch (arg_0xb73c93a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73c93a8);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(204U, "Init", "LEDS: initialized.\n");
...
#line 134
{
  sim_log_debug(152U, "boot", "Application booted for node: %d \n", TOS_NODE_ID);
  RadioRouteC$AMControl$start();
}
...
# 119 "/opt/tinyos-main-2.1.2/tos/system/LedsP.nc"
static uint8_t LedsP$Leds$get(void )
#line 119
{
  uint8_t rval;
...
#line 88
    {
      if (type == 1 && !RadioRouteC$route_req_sent[sim_node()]) {
          RadioRouteC$route_req_sent[sim_node()] = TRUE;
...
#line 94
        if (type == 2 && !RadioRouteC$route_rep_sent[sim_node()]) {
            RadioRouteC$route_rep_sent[sim_node()] = TRUE;
            RadioRouteC$Timer0$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID - 1]);
            RadioRouteC$queued_packet[sim_node()] = *packet;
            RadioRouteC$queue_addr[sim_node()] = address;
          }
...
#line 303
{
  ...
  if (&RadioRouteC$queued_packet[sim_node()] == bufPtr) {
      ...
      sim_log_debug(169U, "radio_send", "Packet sent...");
      sim_log_debug_clear(170U, "radio_send", " at time %s \n", sim_time_string());
    }
  else {
      sim_log_debug(171U, "radio", "send ack error \n");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioRouteC */
  if (!strcmp(varname, "RadioRouteC$routing_table"))
  {
    *addr = (uintptr_t)&RadioRouteC$routing_table[__nesc_mote];
    *size = sizeof(RadioRouteC$routing_table[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$dataP"))
  {
    *addr = (uintptr_t)&RadioRouteC$dataP[__nesc_mote];
    *size = sizeof(RadioRouteC$dataP[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$person_code"))
  {
    *addr = (uintptr_t)&RadioRouteC$person_code[__nesc_mote];
    *size = sizeof(RadioRouteC$person_code[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$num_received"))
  {
    *addr = (uintptr_t)&RadioRouteC$num_received[__nesc_mote];
    *size = sizeof(RadioRouteC$num_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$route_req_sent"))
  {
    *addr = (uintptr_t)&RadioRouteC$route_req_sent[__nesc_mote];
    *size = sizeof(RadioRouteC$route_req_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$route_rep_sent"))
  {
    *addr = (uintptr_t)&RadioRouteC$route_rep_sent[__nesc_mote];
    *size = sizeof(RadioRouteC$route_rep_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$sentData"))
  {
    *addr = (uintptr_t)&RadioRouteC$sentData[__nesc_mote];
    *size = sizeof(RadioRouteC$sentData[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioRouteC */
  memset((void *)&RadioRouteC$routing_table[__nesc_mote], 0, sizeof RadioRouteC$routing_table[__nesc_mote]);
  memset((void *)&RadioRouteC$packet[__nesc_mote], 0, sizeof RadioRouteC$packet[__nesc_mote]);
  memset((void *)&RadioRouteC$dataP[__nesc_mote], 0, sizeof RadioRouteC$dataP[__nesc_mote]);
  ...
  memcpy((void *)&RadioRouteC$person_code[__nesc_mote], (void *)&(int [8]){ 1, 0, 6, 0, 8, 6, 7, 2 }, sizeof RadioRouteC$person_code[__nesc_mote]);
  RadioRouteC$num_received[__nesc_mote] = 0;
  RadioRouteC$route_req_sent[__nesc_mote] = FALSE;
  RadioRouteC$route_rep_sent[__nesc_mote] = FALSE;
  RadioRouteC$sentData[__nesc_mote] = FALSE;
